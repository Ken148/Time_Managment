    ...
    <div class="absolute top-[155px] left-1/2 transform -translate-x-1/2 flex flex-col items-center">
        ...
        <div class="space-y-[14px]">
            ...
            <div class="relative w-[450px] mb-[14px]">
                ...
                <input type="email" class="w-full h-[50px] bg-[#E5E9F0] border border-[#A8B2D1] rounded-[15px] text-[#1E1E30] px-4">
            </div>
            <!-- Password Box -->
            <div class="relative w-[450px] mb-[53px]">
                ...
                <input type="password" class="w-full h-[50px] bg-[#E5E9F0] border border-[#A8B2D1] rounded-[15px] text-[#1E1E30] px-4">
            </div>
        </div>
        
        <!-- REGISTER Link aligned with input box -->
        <a href="register.php">
            <div class="w-[450px] flex justify-start mt-[10px]"> <!-- Added margin for spacing -->
                <div style="width: 82px; height: 31px; padding-bottom: 1px; justify-content: flex-end; align-items: center; display: inline-flex;">
        ...
        <div class="mt-8">
            <a href="404.php">
                <button style="width: 300px; height: 60px; background: #E5E9F0; color: #1E1E30; border-radius: 30px; font-size: 20px; font-family: Poppins; font-weight: 400; text-transform: capitalize; word-wrap: break-word;">
                    Sign In
                </button>
            </a>
        </div>
