    ...
    <form method="POST" action="register.php">
        <div class="space-y-[14px]"> 
            <div class="relative w-[450px] mb-[14px]"> 
                ...
                <input type="text" name="username" class="w-full h-[50px] bg-[#E5E9F0] border border-[#A8B2D1] rounded-[15px] text-[#1E1E30] px-4">
            </div>
            ...
            <div class="relative w-[450px] mb-[14px]"> 
                ...
                <input type="text" name="surname" class="w-full h-[50px] bg-[#E5E9F0] border border-[#A8B2D1] rounded-[15px] text-[#1E1E30] px-4">
            </div>
            ...
            <div class="relative w-[450px] mb-[14px]"> 
                ...
                <input type="email" name="mail" class="w-full h-[50px] bg-[#E5E9F0] border border-[#A8B2D1] rounded-[15px] text-[#1E1E30] px-4">
            </div>
            ...
            <div class="relative w-[450px] mb-[53px]"> 
                ...
                <input type="password" name="pass" class="w-full h-[50px] bg-[#E5E9F0] border border-[#A8B2D1] rounded-[15px] text-[#1E1E30] px-4">
            </div>
        </div>
...
<div class="flex lg:hidden relative w-full h-screen">
    ...
    <div class="absolute left-[83px] top-[360px] w-[113px] h-[29px] bg-[#E5E9F0] rounded-full flex items-center justify-center mt-[28px]">
        <a href="login.php"><button class="text-xs text-[#1E1E30]">Sign In</button></a>
    </div>
