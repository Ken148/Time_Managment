...
<div class="flex lg:hidden relative w-full h-screen">
    ...
    <!-- Login Header -->
    <div class="absolute left-[36px] top-[130px] text-2xl text-[#FFD700] font-medium" style="left: calc(50% - 90px);">Login</div>

    <!-- Form Inputs -->
    <form method="POST" action="login.php">
        <div class="absolute left-[36px] top-[181px] space-y-[23px]">
            <!-- Email Box -->
            <div class="relative">
                <label for="mobile_email" class="absolute text-[#FFD700] text-xs -top-3 left-0">Email</label>
                <input id="mobile_email" type="email" name="mail" class="w-[216px] h-[35px] bg-[#E5E9F0] border border-[#A8B2D1] rounded-[15px] text-[#FFD700] px-2.5" style="margin-top: 5px;">
            </div>
    
            <!-- Password Box -->
            <div class="relative">
                <label for="mobile_password" class="absolute text-[#FFD700] text-xs -top-3 left-0">Password</label>
                <input id="mobile_password" type="password" name="pass" class="w-[216px] h-[35px] bg-[#E5E9F0] border border-[#A8B2D1] rounded-[15px] text-[#FFD700] px-2.5" style="margin-top: 5px;">
            </div>
    
            <!-- REGISTER Link styled and aligned -->
            <a href="register.php">
                <div class="w-[450px] flex justify-start mt-[10px]">
            ...
            <!-- Google Login Button aligned to the right of the input boxes -->
                <div style="display: flex; justify-content: flex-end; width: 475px; margin-top: -50px; margin-left: -245px;"> <!-- Added -20px margin-top -->
                    <a href="<?php echo $authUrl; ?>" style="text-decoration: none;">
                        <img src="pictures/google.png" style="width: 150px; height: auto;">
                    </a>
                </div>
        </div>
    
        <!-- Centered Sign In Button (moved 28px below the password input box) -->
        <div class="absolute left-[83px] top-[300px] w-[113px] h-[29px] bg-[#E5E9F0] rounded-full flex items-center justify-center mt-[28px]">
